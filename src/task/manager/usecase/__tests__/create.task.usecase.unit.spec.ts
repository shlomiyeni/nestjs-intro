...
describe('CatsController', () => {
    ...
    beforeEach(() => {
        ...
        createTaskUsecase = new CreateTaskUsecase(taskRepository, userEmailValidator, globalService)
    });

    describe('findAll', () => {
        it('should return an array of cats', async () => {
            const result = ['test'];
            jest.spyOn(userEmailValidator, 'validate').mockImplementation(async () => true);
